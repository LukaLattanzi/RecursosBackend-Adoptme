...
describe('Users API', () => {
  ...
  beforeEach(() => {
    // Crear instancia de express por test para aislar mutaciones
    app = express();
  ...
  afterEach(() => {
    // Restaurar métodos originales si fuera necesario (simplemente reasignamos objetos)
  });
  ...
  it('GET /api/users/:uid - devuelve 404 cuando no existe', async () => {
    ...
    // En modo desarrollo el handler devuelve message
